//Keep both the marker and the viewport within the background boundary
...
function playGame() {
	...
	//Keep viewport within the background boundary	
	viewport.x = Math.max(background.x, Math.min(marker.x + marker.width/2 - viewport.width/2, background.x + background.width - viewport.width));
	viewport.y = Math.max(background.y, Math.min(marker.y + marker.height/2 - viewport.height/2, background.y + background.height - viewport.height));
